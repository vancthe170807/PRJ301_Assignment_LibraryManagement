                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listFeedback}" var="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="DeleteFeedback?id=${i.id}" dclass="table-link danger" style="text-decoration: none; color: red;" 
                                                           title="Detele Feedback" onclick="return confirm('Are you sure Detele Feedback of ${i.username}?');">
                                                            <span class="fa-stack">
