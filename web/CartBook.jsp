...
<html>
    ...
    <body class="sb-nav-fixed" style="overflow-x: hidden">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="HomePageUser">Library</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content"style="background-color: #eee;">
                <main >
                    <div class="container py-5">
                        <c:if test="${sessionScope.CartBooks == null}">
                            <p class="text-center text-danger"><strong>Empty Book</strong></p>
                        </c:if>
                        <c:forEach items="${sessionScope.CartBooks}" var="i">
                ...
                <c:if test="${sessionScope.CartBooks != null and sessionScope.CartBooks.size() > 0}">
                    <form class="w-100 justify-content-center d-flex" action="ConfirmBorrow" method="GET">
                        <button type="submit" class="btn btn-primary w-25 justify-content-center">Borrow All</button>
                    </form>
                </c:if>
                <!-- Footer -->
