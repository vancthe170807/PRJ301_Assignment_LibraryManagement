            ...
            <main>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.list}" var="i">
                                            <tr>
                                                ...
                                                <td class="text-center">${i.borrow_from}</td>
                                                <td class="text-center">${i.borrow_to}</td>

                                                <!-- Action (Return Book) -->
                                                <td class="text-center">
                                                    <a href="ReturnBorrower?id=${i.id}&bookid=${i.bookid}" class="table-link btn btn-primary btn-sm" style="text-decoration: none;" title="Book Returned">
                                                            Return
                                                    </a>
                                                </td>
                                            </tr>
                        ...
                        <!-- Pagination for more than one page -->
